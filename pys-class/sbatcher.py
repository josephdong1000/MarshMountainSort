...
def main():
    ...
    batchparams = [
        ...
        # "--id 579-580 --datadir rhds --intanport A -aI A B -o 'overnight 1-17-25'", # TODO currently recording
        # "--id 579-580 --datadir rhds --intanport B -aI A B -o 'overnight 1-17-25'", # TODO currently recording
        ...
        "--mode depth --id 579 --nosort", # TODO
        "--mode depth --id 580 --nosort", # TODO
    ]
